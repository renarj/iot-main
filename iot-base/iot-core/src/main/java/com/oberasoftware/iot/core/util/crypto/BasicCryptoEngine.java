...
public class BasicCryptoEngine implements CryptoEngine {
    ...
    @Override
    public String encrypt(String salt, String password, String textToEncrypt) throws java.lang.SecurityException {
        ...
        try {
            ...
            throw new java.lang.SecurityException("Unable to encrypt", e);
        }
    }
    ...
    @Override
    public String decrypt(String salt, String password, String encryptedText) throws java.lang.SecurityException {
        String standardPass = getStandardizedPassword(password);
        ...
        try {
            ...
            return new String(cipher.doFinal(encrypted), UTF8);
                ...
                | BadPaddingException | NoSuchPaddingException | IllegalBlockSizeException | InvalidKeyException e) {
            throw new java.lang.SecurityException("Unable to decrypt", e);
        }
    }

    @Override
    public String hash(String salt, String password) throws java.lang.SecurityException {
        try {
