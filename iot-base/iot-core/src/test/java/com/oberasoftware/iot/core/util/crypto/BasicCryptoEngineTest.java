...
public class BasicCryptoEngineTest {
    ...
    @Test
    public void testEmptyPasswordEncrypt() throws java.lang.SecurityException {
    ...
    @Test
    public void testPasswordEncrypt() throws java.lang.SecurityException {
        BasicCryptoEngine cryptoEngine = new BasicCryptoEngine();
        String salt = cryptoEngine.generateSalt();
    ...
    public void testInvalidPasswordDecrypt() throws java.lang.SecurityException {
        BasicCryptoEngine cryptoEngine = new BasicCryptoEngine();
        String salt = cryptoEngine.generateSalt();
