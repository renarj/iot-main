...
public class ServoController {
    ...
    @RequestMapping(value = "/reset/{servoId}", method = RequestMethod.POST)
    public void resetServo(@PathVariable String servoId) {
        LOG.info("Resetting servo: {}", servoId);
        getServoDriver().resetServo(servoId);
    }

    @RequestMapping(value = "/resetAll", method = RequestMethod.POST)
    public void resetServos() {
        LOG.info("Resetting all servos");
